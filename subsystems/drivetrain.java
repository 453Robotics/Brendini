 ...
 * project.
 */
public class drivetrain extends subsSystembase implements Command {
  ...
  public drivetrain(ExampleSubsystem m_exampleSubsystem) {
  }
  ...
  public void robotInit() {
    ...
    m_leftMotorF = new CANSparkMax(leftdeviLIDF, MotorType.kBrushless);///////////// Follower
    m_rightMotorF = new CANSparkMax(rightdeviLIDF, MotorType.kBrushless);/////////// Follower
